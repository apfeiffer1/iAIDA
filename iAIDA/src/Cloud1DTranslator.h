...
// Header file for class Cloud1DTranslator
// 
 ...
 *    AIDA Cloud1D plus name and path and creates a DataXML::DataObject. 
...
#ifndef CLOUD1DTRANSLATOR
#define CLOUD1DTRANSLATOR 1
...
class Cloud1DTranslator : public Translator {
...
public: 
  ...
  const AIDA::ICloud1D * histo() { return m_cloud; } 
