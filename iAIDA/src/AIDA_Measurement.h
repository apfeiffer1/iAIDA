// Emacs -*- C++ -*-
#ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDAMEASUREMENT
#define AIDANATIVE_AIDA_DATAPOINTSET_AIDAMEASUREMENT 1
...
#endif /* ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDAMEASUREMENT */
