// Emacs -*- C++ -*-
#ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDADATAPOINTSET
#define AIDANATIVE_AIDA_DATAPOINTSET_AIDADATAPOINTSET 1
...
#endif /* ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDADATAPOINTSET */
