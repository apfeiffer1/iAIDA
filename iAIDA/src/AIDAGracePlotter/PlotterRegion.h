...
#ifndef AIDANATIVE_QPLOTTER_NEW_VIEWER_PLOTTER_REGION_H
#define AIDANATIVE_QPLOTTER_NEW_VIEWER_PLOTTER_REGION_H
...
#endif // AIDANATIVE_QPLOTTER_NEW_VIEWER_PLOTTER_REGION_H
