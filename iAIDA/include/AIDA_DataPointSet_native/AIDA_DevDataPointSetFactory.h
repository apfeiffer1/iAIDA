// Emacs -*- C++ -*-
#ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDADEVDATAPOINTSETFACTORY
#define AIDANATIVE_AIDA_DATAPOINTSET_AIDADEVDATAPOINTSETFACTORY 1
...
#endif /* ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDADEVDATAPOINTSETFACTORY */
