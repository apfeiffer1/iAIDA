// Emacs -*- C++ -*-
#ifndef AIDANATIVE_AIDA_TUPLE_EVALUATOREXPRESSIONBASE
#define AIDANATIVE_AIDA_TUPLE_EVALUATOREXPRESSIONBASE 1
...
#endif /* ifndef AIDANATIVE_AIDA_TUPLE_EVALUATOREXPRESSIONBASE */
