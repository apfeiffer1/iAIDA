// Emacs -*- C++ -*-
#ifndef AIDANATIVE_AIDA_TUPLE_FILTEREXPRESSIONBASE
#define AIDANATIVE_AIDA_TUPLE_FILTEREXPRESSIONBASE 1
...
#endif /* ifndef AIDANATIVE_AIDA_TUPLE_FILTEREXPRESSIONBASE */
