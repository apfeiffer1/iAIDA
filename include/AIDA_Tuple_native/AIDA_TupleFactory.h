// Emacs -*- C++ -*-
#ifndef AIDANATIVE_AIDA_TUPLE_AIDA_TUPLEFACTORY_H
#define AIDANATIVE_AIDA_TUPLE_AIDA_TUPLEFACTORY_H 1
...
#endif /* ifndef AIDANATIVE_AIDA_TUPLE_AIDA_TUPLEFACTORY_H */
