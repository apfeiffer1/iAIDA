...
// Implementation file for class AIDA_Profile2DIterator
// 
...
namespace iAIDA  { 
  namespace AIDA_Fitter { 
    ...
    AIDA_Profile2DIterator::AIDA_Profile2DIterator(const AIDA::IProfile2D& h, int ix, int iy) : m_hist(&h), m_dim(h.dimension()), xIndex(ix), yIndex(iy)
    { 
    }

    AIDA_Profile2DIterator::~AIDA_Profile2DIterator() 
    {
    }

    AIDA_Profile2DIterator::AIDA_Profile2DIterator(const AIDA_Profile2DIterator &a) 
      : AIDA_FitDataIterator(a)
    {
    }

    AIDA_Profile2DIterator & AIDA_Profile2DIterator::operator = (const AIDA_Profile2DIterator &rhs) 
    {
