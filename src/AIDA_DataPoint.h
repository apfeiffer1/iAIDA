// Emacs -*- C++ -*-
#ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDADATAPOINT
#define AIDANATIVE_AIDA_DATAPOINTSET_AIDADATAPOINT 1
...
#endif /* ifndef AIDANATIVE_AIDA_DATAPOINTSET_AIDADATAPOINT */
