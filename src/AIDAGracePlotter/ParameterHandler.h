...
#ifndef AIDANATIVE_QPLOTTER_NEW_VIEWER_PARAMETER_HANDLER_H
#define AIDANATIVE_QPLOTTER_NEW_VIEWER_PARAMETER_HANDLER_H
...
#endif // AIDANATIVE_QPLOTTER_NEW_VIEWER_PARAMETER_HANDLER_H
